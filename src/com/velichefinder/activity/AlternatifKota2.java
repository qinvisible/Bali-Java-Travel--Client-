...
public class AlternatifKota2 extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_alternatif_kota2);
		getDataKendaraan();
	}
	...
	private void getDataKendaraan(){
		...
		String link=url+"result_alternatif1.php?awal="+setGet.getTujuan()+"&tujuan="+alternatif+"&t_awal="+setGet.getAsal();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_alternatif_kota2, menu);
		return true;
	}
